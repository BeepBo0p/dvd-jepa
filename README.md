...
$$
\mathcal{L} = \bigl\| P\!\left(E_\theta(\text{obs}_t)\right) - \operatorname{sg}\!\left(E_{\text{ema}}(\text{obs}_{t+1})\right) \bigr\|_2^2\;+\; \sum_d \operatorname{ReLU}\!\left(1 - \operatorname{std}(z_d)\right)
$$
